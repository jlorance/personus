...
- **Structure.** `specs/` → `domains/` (one dir per product area); foundation / decisions / guides / research / patterns / business-model / qa kept. Generated `index.md`; conventions in [`_okf.md`](/_okf.md).
